...
ACLOCAL = ${SHELL} /Users/cjimison/Develop/external/thrift_base/thrift/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
...
ANT_FLAGS = 
AR = ar
AUTOCONF = ${SHELL} /Users/cjimison/Develop/external/thrift_base/thrift/missing autoconf
AUTOHEADER = ${SHELL} /Users/cjimison/Develop/external/thrift_base/thrift/missing autoheader
AUTOMAKE = ${SHELL} /Users/cjimison/Develop/external/thrift_base/thrift/missing automake-1.15
AWK = awk
BISON = bison
BOOST_CHRONO_LDADD = /usr/local/Cellar/boost/1.58.0//lib/libboost_chrono.a
BOOST_CPPFLAGS = -I/usr/local/Cellar/boost/1.58.0//include
BOOST_FILESYSTEM_LDADD = /usr/local/Cellar/boost/1.58.0//lib/libboost_filesystem.a
BOOST_LDFLAGS = -L/usr/local/Cellar/boost/1.58.0//lib
BOOST_LIB_DIR = /usr/local/Cellar/boost/1.58.0//lib
BOOST_SYSTEM_LDADD = /usr/local/Cellar/boost/1.58.0//lib/libboost_system.a
BOOST_TEST_LDADD = /usr/local/Cellar/boost/1.58.0//lib/libboost_unit_test_framework.a
BOOST_THREAD_LDADD = /usr/local/Cellar/boost/1.58.0//lib/libboost_thread.a
BUNDLER = 
CABAL = true
...
ERLANG_INSTALL_LIB_DIR = /usr/local/Cellar/erlang/18.1/lib/erlang/lib
ERLANG_INSTALL_LIB_DIR_thrift = ${ERLANG_INSTALL_LIB_DIR}/thrift-1.0.0-dev
ERLANG_LIB_DIR = /usr/local/Cellar/erlang/18.1/lib/erlang/lib
...
GCOV_CXXFLAGS = 
GCOV_LDFLAGS = 
GLIB_CFLAGS = -I/usr/local/Cellar/glib/2.46.0/include/glib-2.0 -I/usr/local/Cellar/glib/2.46.0/lib/glib-2.0/include -I/usr/local/opt/gettext/include 
GLIB_LIBS = -L/usr/local/Cellar/glib/2.46.0/lib -L/usr/local/opt/gettext/lib -lglib-2.0 -lintl 
GO = 
GOBJECT_CFLAGS = -I/usr/local/Cellar/glib/2.46.0/include/glib-2.0 -I/usr/local/Cellar/glib/2.46.0/lib/glib-2.0/include -I/usr/local/opt/gettext/include 
GOBJECT_LIBS = -L/usr/local/Cellar/glib/2.46.0/lib -L/usr/local/opt/gettext/lib -lgobject-2.0 -lglib-2.0 -lintl 
GREP = /usr/bin/grep
HAVE_CXX11 = 1
HAXE = 
HAXE_VERSION = 
...
LUA_SHORT_VERSION = 
LUA_VERSION = 
MAKEINFO = ${SHELL} /Users/cjimison/Develop/external/thrift_base/thrift/missing makeinfo
MANIFEST_TOOL = :
MAYBE_CPP = cpp
MAYBE_CSHARP = csharp
MAYBE_C_GLIB = c_glib
...
OBJDUMP = false
OBJEXT = o
OPENSSL_INCLUDES = -I/usr/local/Cellar/openssl/1.0.2d_1/include
OPENSSL_LDFLAGS = -L/usr/local/Cellar/openssl/1.0.2d_1/lib
...
QT5_LIBS = 
QT5_MOC = 
QT_CFLAGS = -DQT_SHARED -I/usr/local/Cellar/qt/4.8.7_1/include -I/usr/local/Cellar/qt/4.8.7_1/include/QtNetwork -I/usr/local/Cellar/qt/4.8.7_1/include -I/usr/local/Cellar/qt/4.8.7_1/include/QtCore 
QT_LIBS = -F/usr/local/Cellar/qt/4.8.7_1/lib -framework QtNetwork -F/usr/local/Cellar/qt/4.8.7_1/lib -framework QtCore 
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /Users/cjimison/Develop/external/thrift_base/thrift/lib/erl
abs_srcdir = /Users/cjimison/Develop/external/thrift_base/thrift/lib/erl
abs_top_builddir = /Users/cjimison/Develop/external/thrift_base/thrift
abs_top_srcdir = /Users/cjimison/Develop/external/thrift_base/thrift
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/cjimison/Develop/external/thrift_base/thrift/install-sh
